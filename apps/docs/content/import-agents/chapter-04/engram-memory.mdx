---
title: "Engram记忆网络"
description: "4.5 Engram 记忆网络：让 AI 有记忆"
---

# 4.5 Engram 记忆网络：让 AI 有记忆

> 智能的本质是网络的形状

前面几节，我们学习了如何通过角色和工具填补上下文鸿沟。但还有一个根本性的问题没有解决：
...
[上一节：Luban 工具创建](4.4-Luban工具创建.md) | [返回目录](README.md) | [下一节：本章小结](4.6-本章小结.md)
